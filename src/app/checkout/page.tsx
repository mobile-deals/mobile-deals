          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-neutral-200/90 p-6 shadow-xs space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-xs font-bold uppercase text-neutral-700 tracking-wider mb-1.5">
                    District / Area <span className="text-rose-600">*</span>
                  </label>
                  <select
                    value={formData.area}
                    onChange={(e) =>
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-neutral-300 text-sm bg-white focus:outline-none focus:border-[#8A1538] focus:ring-2 focus:ring-[#8A1538]/10"
                  >
                    {POPULAR_QATAR_AREAS.map((area) => (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="e.g. 840 / Al Waab St"
                      className="w-full px-4 py-3 rounded-xl border border-neutral-300 text-sm focus:outline-none focus:border-[#8A1538]"
                    />
                  </div>
                ...
                <div>
                  <label className="block text-xs font-bold uppercase text-neutral-700 tracking-wider mb-1.5">
                    Delivery Instructions / Landmark Notes
                  </label>
                  <textarea
                    rows={2}
